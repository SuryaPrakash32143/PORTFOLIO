    ...
    <footer className="footer">
      <div className="container">
        <div className="footer-content">
          <div className="footer-left">
            ...
            <p className="footer-tagline">
              Building intelligent solutions for tomorrow's problems
            </p>
          </div>
          ...
          <div className="footer-links">
            ...
            <div className="footer-column">
              ...
              <ul>
                <li>
                  <a href="https://github.com/SuryaPrakash32143" target="_blank" rel="noopener noreferrer">
                    GitHub
                  </a>
                </li>
                <li>
                  <a href="https://linkedin.com/in/surya-prakash-mullapudi-585355332" target="_blank" rel="noopener noreferrer">
                    LinkedIn
                  </a>
                </li>
                <li>
                  <a href="mailto:suryaprakash321433@gmail.com">
                    Email
                  </a>
                </li>
              </ul>
        ...
        <div className="footer-bottom">
          <p>© {currentYear} Surya Prakash. All rights reserved.</p>
